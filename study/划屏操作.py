...
# dj = (MobileBy.ANDROID_UIAUTOMATOR,'new UiSelector().text("Python自动化")')
# driver.find_element(*dj).click()
# cj = (MobileBy.ID,'com.lemon.lemonban:id/first_level')
# wait.until(EC.visibility_of_element_located(cj))
